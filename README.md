...
I work with **Go, JavaScript/TypeScript (React/Node.js), Python, REST APIs, WebSockets, PostgreSQL/SQLite, and Docker**, and focused on building **clean, reliable, and observable systems**.
...
- **Bookworms Forum** — Full-stack forum | Go · SQLite · Docker  
  Encrypted login, nested like/dislike logic, category mapping, and a fully containerized setup

- **Multiplayer Browser Game** | JavaScript · WebSockets · DOM-based rendering  
